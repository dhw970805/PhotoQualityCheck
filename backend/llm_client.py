...
{ "is_bad_photo": boolean, // true 表示是坏照片需剔除,false 表示是好照片可保留 "expressionScore": integer, // 0-100 分，坏照片通常低于 60 分 "compositionScore": integer, // 0-100 分，坏照片通常低于 60 分 "exposureScore": integer, // 0-100 分，坏照片通常低于 60 分 "reasons": [ // 数组，列出所有触发的坏照片原因代码，若无则为空数组 "unnatural_expression", "blinking", // 仅当微笑且闭眼时填写此项 "poor_composition", "exposure_issue" ], "detailed_analysis": "string" // 用一句话简短描述具体问题，例如："新娘在严肃时刻意外眨眼" 或 "笑容灿烂虽闭眼但情感自然，保留" }
